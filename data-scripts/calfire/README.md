...
- Logging to `/home/ubuntu/data/calfire/<process_name>_TRACE.log`
...
4. Logs each run to `/home/ubuntu/data/calfire/calfire_cacher_TRACE.log`
...
- Create `/home/ubuntu/data/calfire` if it does not already exist
...
A typical log file entry in `/home/ubuntu/data/calfire/calfire_cacher_TRACE.log` might look like:
...
- The script writes logs to `/home/ubuntu/data/calfire`.
